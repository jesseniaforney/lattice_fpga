...
reg r_switch_state;                                            // Internal signal to register the state of the Switch. In Verilog would use reg instead of logic
reg r_led_state;                                               // Internal signal to register the state of the LED output. In Verilog would use reg instead of logic

always @(posedge i_clk) begin                                  // In Verilog would be: always @(posedge i_clk)
    if (i_rst) begin
